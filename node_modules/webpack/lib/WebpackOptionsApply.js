...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/evargas/.vscode/extensions/wallabyjs.console-ninja-1.0.336/out/buildHook/index.js').default({tool: 'webpack'}); } catch(cjsError) { try { import('file:///home/evargas/.vscode/extensions/wallabyjs.console-ninja-1.0.336/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
